...
SP    : " "
NL    : "\n"
SIGNO   : "Aries" | "Touro" | "Gemeos" | "Cancer" | "Leao" | "Virgem" | "Libra" | "Escorpiao" | "Serpentário" | "Sagitario" | "Capricornio" | "Aquario" | "Peixes"
PLANETA : "Mercurio" | "Venus" | "Lua" | Marte" | "Jupiter" | "Saturno" | "Urano" | "Netuno" | "Plutao" | "Eris" | "Ceres" | "Haumea" | "Makemake" | "Sedna" 
""")
